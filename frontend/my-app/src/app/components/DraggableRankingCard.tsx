...
function getRankIcon(rank: number): React.ReactNode | null {
  ...
  if (rank <= 3) return <Medal className="w-6 h-6 text-cyan-400" />;
  if (rank <= 10) return <Star className="w-6 h-6 text-yellow-400" />;
  return null;
}
    ...
    >
      ...
      >
        ...
        <div className="flex items-center gap-3 mb-3 sm:mb-0">
          ...
          <div className="w-10 h-10 sm:w-12 sm:h-12 flex items-center justify-center rounded-xl bg-light-200/50 dark:bg-dark-100/50 border border-black/10 dark:border-white/10 font-bold text-light-900 dark:text-white">
          ...
          {isAuthenticated ? (
            <>
              <input
                ...
                className="px-3 py-1.5 rounded-xl border border-black/10 dark:border-white/10 bg-light-200/50 dark:bg-dark-100/50 text-light-900 dark:text-white placeholder-light-500 dark:placeholder-gray-500 w-24 sm:w-32 focus:outline-none focus:border-cyber-500/50"
              />
              <input
                type="text"
