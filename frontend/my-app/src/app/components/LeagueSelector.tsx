...
// Toast notification component (mobile-friendly)
const Toast = ({
  message,
  type,
  onClose,
  ...
  <div
    className={`fixed top-4 left-4 right-4 sm:left-auto sm:right-4 z-50 px-4 sm:px-6 py-3 sm:py-4 rounded-xl shadow-2xl transform transition-all duration-500 backdrop-blur-sm ${
      type === "success"
...
export default function LeagueSelector({
  ...
  useEffect(() => {
    ...
    const unsubscribe = subscribeToLeagues((updatedLeagues) => {
      ...
      const savedLeague = updatedLeagues.find(
        (league) => league.id === savedCurrentId
      );
  ...
  const validateLeagueName = (
    ...
    const existingLeague = leagues.find(
      (league) =>
        league.name.toLowerCase() === name.trim().toLowerCase() &&
        league.id !== excludeId
    );
  ...
  return (
    <>
      ...
      <div className="mb-8 bg-white/10 backdrop-blur-sm rounded-2xl shadow-2xl overflow-hidden">
        {/* Header */}
        <div className="bg-gradient-to-r from-indigo-600 via-purple-600 to-blue-600 px-4 sm:px-8 py-5 sm:py-6">
            ...
            <div className="flex items-center gap-3 sm:gap-4">
              ...
              <div>
                ...
                <p className="text-white/80 text-xs sm:text-sm">
                  Select or create your football league
                </p>
              </div>
            </div>
            {currentLeague && (
        ...
        <div className="p-4 sm:p-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4">
                {leagues.map((league, index) => {
                  ...
                  return (
                    <div
                      key={league.id}
                      className={`group relative p-4 sm:p-6 rounded-xl transition-all duration-300 cursor-pointer transform hover:scale-[1.02] ${
                        isActive
                    ...
                    >
                        ...
                        <div className="flex items-center gap-3 flex-1 min-w-0">
                          <div
                            className={`w-3 h-3 rounded-full ${
                              isActive ? "bg-white/80" : "bg-blue-400"
                            }`}
                          />
                          {isEditing ? (
                            <input
                              ...
                              className={`w-full max-w-full font-bold text-base sm:text-lg rounded-lg px-2 py-1 focus:outline-none ${
                                isActive
                                  ? "bg-white text-black"
                                  : "bg-white text-black"
                              }`}
                            ...
                            {isEditing ? (
                              <>
                                <button
                                  ...
                                  disabled={isLoading}
                                  className="p-2 rounded-lg hover:bg-blue-50/30"
                                  title="Save changes"
                                >
                                  <Image
                      ...
                      <div className="flex items-center justify-between">
                        <div className="text-xs sm:text-sm">
                          {isActive ? (
                            ...
                            <span className="text-gray-500">Tap to switch</span>
                          )}
                        </div>
                      ...
                      {isActive && (
                        <div className="absolute top-2 right-2">
                          <div className="w-3 h-3 bg-white/80 rounded-full animate-ping" />
                          <div className="absolute top-0 right-0 w-3 h-3 bg-white/80 rounded-full" />
                        </div>
                      )}
                    </div>
                  );
          ...
          {/* Create New League */}
          <div className="rounded-xl p-4 sm:p-5 bg-white/5">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-4 sm:mb-6">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-white/80 text-xs sm:text-sm">
                    Start managing a new football league
                  </p>
                </div>
              </div>
              ...
              {!isCreatingNew && !editingLeague && (
                <button
                  ...
                  disabled={isLoading}
                  className="self-start sm:self-auto bg-gradient-to-r from-blue-500 to-indigo-500 text-white px-4 sm:px-6 py-2.5 sm:py-3 rounded-xl hover:from-blue-600 hover:to-indigo-600 transition-all duration-300 shadow-lg font-semibold disabled:opacity-50"
                >
                  New League
                </button>
              )}
                ...
                <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
                  <div className="flex-1">
                    <input
                      ...
                      onKeyDown={handleKeyPress}
                      className="w-full px-4 py-3 border-2 border-white/20 rounded-xl text-white placeholder-white/60 bg-white/10 focus:outline-none focus:border-blue-400 focus:ring-4 focus:ring-blue-200/30 transition-all duration-300"
                      autoFocus
                      maxLength={50}
                      disabled={isLoading}
                    />
                  ...
                  <div className="flex gap-2 sm:gap-3">
                    <button
                      ...
                      className="bg-gradient-to-r from-blue-500 to-indigo-500 hover:from-blue-600 hover:to-indigo-600 disabled:from-gray-400 disabled:to-gray-500 text-white px-4 sm:px-6 py-2.5 sm:py-3 rounded-xl font-semibold transition-all duration-300 shadow-lg disabled:cursor-not-allowed"
                    >
                      {isLoading ? (
                    ...
                    <button
                      ...
                      disabled={isLoading}
                      className="bg-gray-600 hover:bg-gray-700 text-white px-4 sm:px-6 py-2.5 sm:py-3 rounded-xl font-semibold transition-all duration-300"
                    >
                      Cancel
                    </button>
                  </div>
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div className="min-w-0">
                        ...
                        <div className="text-xs text-gray-500">
                          Ready to add teams and matches
                        </div>
                      </div>
                    </div>
                  </div>
            ...
            <div className="p-6 sm:p-8">
              ...
              <div className="flex flex-col sm:flex-row gap-2 sm:gap-4">
                ...
                <button
                  ...
                  disabled={isLoading}
                  className="flex-1 bg-gradient-to-r from-red-500 to-red-600 hover:from-red-600 hover:to-red-700 text-white px-6 py-3 rounded-xl font-bold transition-all duration-300"
                >
                  {isLoading ? (
